...
public final class JsonKit { // NOPMD
    ...
    public static <T> T fromFile(@NotNull final TypeReference<T> reference,
            @NotNull @NotEmpty @NotBlank final String file) throws Exception {
        T ret = null;
        try {
     ...
     * @return
     */
    public static JsonNode readJson(@NotNull @NotEmpty @NotBlank final String filePath) throws Exception {
