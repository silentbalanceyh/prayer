...
public final class DataExecutors {
    ...
    /** **/
    private static final CommonQuerier QUERIER = singleton(CommonQuerier.class);
    ...
    private static List<Record> queryRecords(final JsonObject data) throws AbstractException {
        ...
        if (data.containsKey("id") && data.containsKey("value")) {
            ...
            if (Constants.ONE == value.fieldNames().size()) {
                ...
                /** 提取返回值 **/
                records.addAll(QUERIER.queryMuster(identifier, field, params.toArray(Constants.T_STR_ARR)));
            }
            // 如果长度不为1跳过
        }
        return records;
