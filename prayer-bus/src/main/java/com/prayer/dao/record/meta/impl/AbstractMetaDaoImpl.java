...
import com.prayer.kernel.JsonEntity;
 ...
 */
@Guarded
public abstract class AbstractMetaDaoImpl<T extends AbstractMetadata, ID extends Serializable> implements RecordDao {
    // ~ Static Fields =======================================
    // ~ Instance Fields =====================================
    /** **/
    @NotNull
