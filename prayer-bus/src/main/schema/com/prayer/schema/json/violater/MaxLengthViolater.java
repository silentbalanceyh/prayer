 ...
 */
@Guarded
public final class MaxLengthViolater extends AbstractViolater implements Violater {
    // ~ Static Fields =======================================
    // ~ Instance Fields =====================================
    /** **/
    @NotNull
    ...
    /** **/
    @PostValidateThis
    public MaxLengthViolater(@NotNull @InstanceOfAny(MaxLengthRule.class) final Rule rule) {
        this.rule = rule;
    }
    ...
    public AbstractSchemaException violate(@NotNull final ObjectHabitus habitus) {
        ...
        final String key = VExecutor.map(fieldLen, expectes, VCondition::gt);
        if (null != key) {
