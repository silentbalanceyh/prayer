...
public final class MetaRaw {
        ...
        if (this.types.isEmpty()) {
            ...
            for (final String literal : literals) {
                if (StringKit.isNonNil(literal)) {
                    ...
                    if (null == type) {
                        throw new MetaTypeWrongException(getClass(), literal, Resources.OOB_SCHEMA_FILE, key);
                    }
                    this.types.add(type);
                }
            }
    ...
    private List<String> readArray(final String key) throws AbstractDatabaseException {
        ...
        if (ret.isEmpty()) {
            throw new MetadataDefMissingException(getClass(), Resources.OOB_SCHEMA_FILE, key);
        }
        return ret;
    }
