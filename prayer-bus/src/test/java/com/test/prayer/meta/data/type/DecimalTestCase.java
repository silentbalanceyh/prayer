...
public class DecimalTestCase {
	...
	public void testDecimal3(){
		...
		assertEquals("[T] DecimalType -> String", data1.getValue(), data2.getValue());
	}
	...
	public void testDecimal6(){
		final DecimalType data = new DecimalType();
		assertEquals("[T] test getDataType", DataType.DECIMAL, data.getDataType());
	}
	...
	public void testDecimal7(){
		...
		final DecimalType data2 = new DecimalType("1.00");
		data1.setValue("1.00");
		assertEquals("[T] test setValue -> String", data2.getValue(), data1.getValue());
	}
