...
public class _01RootAttrTestCase extends AbstractSchemaTestCase { // NOPMD
    // ~ Static Fields =======================================
    /** **/
    private static final Logger LOGGER = LoggerFactory.getLogger(_01RootAttrTestCase.class);
    ...
    public void testP001Fields10001() throws AbstractSchemaException {
        testImport("P001root-fields10001.json", "[E10001] Fields ==> (Failure) There is unexpected exception!");
    }
    ...
    public void testP001Keys10001() throws AbstractSchemaException {
        testImport("P001root-keys10001.json", "[E10001] Keys ==> (Failure) There is unexpected exception!");
    }
    ...
    public void testP001Meta10001() throws AbstractSchemaException {
        testImport("P001root-meta10001.json", "[E10001] Meta ==> (Failure) There is unexpected exception!");
    }
    ...
    public void testP002Fields10002() throws AbstractSchemaException {
        testImport("P002root-fields10002.json", "[E10002] Fields ==> (Failure) There is unexpected exception!");
    }
    ...
    public void testP002Keys10002() throws AbstractSchemaException {
        testImport("P002root-keys10002.json", "[E10002] Keys ==> (Failure) There is unexpected exception!");
    }
    ...
    public void testP002Meta10002() throws AbstractSchemaException {
        testImport("P002root-meta10002.json", "[E10002] Meta ==> (Failure) There is unexpected exception!");
    }
    ...
    public void testP003Meta10017() throws AbstractSchemaException {
        testImport("P003root-fields10017.json", "[E10017] Root ==> (Failure) There is unexpected exception!");
    }
    // ~ Private Methods =====================================
    // ~ Get/Set =============================================
