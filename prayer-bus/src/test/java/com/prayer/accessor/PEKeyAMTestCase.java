...
public class PEKeyAMTestCase extends AbstractAMTestCase<PEKey> {
    ...
    public void testInsert() throws AbstractDatabaseException {
        assertTrue(insert("/accessor/pekey/key.json"));
    }
    ...
    public void testUpdate() throws AbstractDatabaseException {
        assertTrue(update("/accessor/pekey/key2.json", "/accessor/pekey/key2update.json"));
    }
    ...
    public void testBatch() throws AbstractDatabaseException {
        assertTrue(batchOp("/accessor/pekey/key3.json"));
    }
    ...
    public void testPage() throws AbstractDatabaseException {
        assertTrue(page("/accessor/pekey/key4.json", "/accessor/pekey/key4page.json"));
    }
    ...
    public void testWhere() throws AbstractDatabaseException {
        // 特殊的查询语句，Where子句
        final Expression filter = Restrictions.eq("S_NAME", new StringType("testname.lang"));
        assertTrue(selectWhere("/accessor/pekey/key5.json", filter));
    }
    // ~ Private Methods =====================================
    // ~ Get/Set =============================================
