 ...
 *
 */
public class RuleDaoTestCase extends AbstractRecordDaoTool {
    // ~ Static Fields =======================================
    /** **/
    private static final Logger LOGGER = LoggerFactory.getLogger(RuleDaoTestCase.class);
    ...
    protected ConcurrentMap<String, Value<?>> specValues() {
        ...
        data.put("componentType",new StringType(Assistant.randArray("VALIDATOR","CONVERTOR","DEPENDANT")));
        ...
        data.put("componentClass", new StringType(EntityHandler.class.getName()));
        data.put("refUID", new StringType(null));
        return data;
    }
    // ~ Methods =============================================
