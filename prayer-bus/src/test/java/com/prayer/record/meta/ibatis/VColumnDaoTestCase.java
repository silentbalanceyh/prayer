 ...
 *
 */
public class VColumnDaoTestCase extends AbstractRecordDaoTool {
    // ~ Static Fields =======================================
    /** **/
    private static final Logger LOGGER = LoggerFactory.getLogger(VColumnDaoTestCase.class);
    ...
    protected ConcurrentMap<String, Value<?>> specValues() {
        ...
        data.put("refViewId", new StringType(null));
        return data;
    }
    // ~ Methods =============================================
