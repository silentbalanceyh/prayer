...
public class _019LeastVerifierTestCase extends AbstractVerifierTestCase {
    ...
    // ~ Constructors ========================================
    /** **/
    public _019LeastVerifierTestCase() {
        this.validator = singleton(validator());
    ...
    public void setDown() {
        ...
        if (null == validator.verifyTable("TST_SUBROLE")) {
            this.connection.executeBatch("DROP TABLE TST_SUBROLE;");
        }
        if (null == validator.verifyTable("TST_SUBROLE1")) {
            this.connection.executeBatch("DROP TABLE TST_SUBROLE1;");
        }
    }
    // ~ Methods =============================================
